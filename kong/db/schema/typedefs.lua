...
typedefs.semantic_version = Schema.define {
  ...
  description = "A string representing a semantic version number in the format X.Y.Z (where X, Y, and Z are integers). The version number may optionally include a hyphen-separated build identifier."
}
